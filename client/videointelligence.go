...
import (
	...
	v1 "github.com/djthorpe/EnterpriseTechnologyDay/googleapi/videointelligence/v1"
	v1beta2 "github.com/djthorpe/EnterpriseTechnologyDay/googleapi/videointelligence/v1beta2"
...
// VideoIntelligenceService defines the client for the Video Intellgence API
type VideoIntelligenceService struct {
...
// NewVideoIntelligenceServiceFromServiceAccountJSON returns client object and error given
// the filename to the Service Account JSON file which can be downloaded from the
// Google Developer Console
func NewVideoIntelligenceServiceFromServiceAccountJSON(filename string, debug bool) (*VideoIntelligenceService, error) {
	...
	if videos, err := v1beta2.New(client); err != nil {
		...
		return &VideoIntelligenceService{videos, ops, make(map[string]*Status)}, nil
	}
}
...
func (this *VideoIntelligenceService) Annotate(uri string, flags AnnotationType) (string, error) {
...
func (this *VideoIntelligenceService) Status(name string) (*Status, error) {
...
func (this *VideoIntelligenceService) getCachedStatus(name string, cacheExpiry time.Duration) (*Status, error) {
	var (
		status *Status
		exists bool
		fetch  bool
...
func (this *VideoIntelligenceService) getCachedProgress(name string, annotationType AnnotationType, cacheExpiry time.Duration) (*Progress, error) {
...
func (this *VideoIntelligenceService) setExplicitAnnotation(status *Status, annotations *v1beta2.GoogleCloudVideointelligenceV1ExplicitContentAnnotation) error {
...
func (this *VideoIntelligenceService) setEntityAnnotations(annotations []*v1beta2.GoogleCloudVideointelligenceV1LabelAnnotation) ([]*EntityAnnotation, error) {
...
func (this *VideoIntelligenceService) setSegmentLabelAnnotations(status *Status, annotations []*v1beta2.GoogleCloudVideointelligenceV1LabelAnnotation) error {
	var err error
...
func (this *VideoIntelligenceService) setShotLabelAnnotations(status *Status, annotations []*v1beta2.GoogleCloudVideointelligenceV1LabelAnnotation) error {
	var err error
...
func (this *VideoIntelligenceService) setShotAnnotations(status *Status, annotations []*v1beta2.GoogleCloudVideointelligenceV1VideoSegment) error {
